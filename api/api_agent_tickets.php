<?php
    ...
    if (!$session->isLoggedIn() || $session->getRole() === Roles::Client->value) die(header("Location: /"));
    ...
    $tickets = Ticket::getAgentTickets($db, $session->getID(), $department, $priority, $status);
